...
- [Skupper Network Observer Extension](#skupper-network-observer-extension)
      - [Add observability and console access to a running Skupper demo](#add-observability-and-console-access-to-a-running-skupper-demo)
  - [Contents](#contents)
